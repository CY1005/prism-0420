...
"export"。M03 已落 TargetType "node" → 不在本测试范围。
...
def test_action_type_enum_includes_m19_export():
    """M19 sprint 新增 "export" action_type 必入 _ACTION_TYPES tuple。"""
    from api.models.activity_log import _ACTION_TYPES

    assert "export" in _ACTION_TYPES


def test_schema_action_type_strenum_includes_export():
    """M19 sprint 新增 "export" 必入 schema StrEnum。"""
