...
status_sprint2: 🟢 NEAR-DONE 2026-05-10 / Task 2.1+2.2 基础设施 ✅ + Task 2.3 全 9 spec ✅（02-10 / 19 e2e PASS / 含 D 类 #3 join 实证 + L1-α detach 实证 + 4C.3 expunge fix + M16/M18/M19 smoke）+ Task 2.4 完整版 ✅（1000 project / bulk_insert / baseline.json 落 / pytest 1643）/ Task 2.5 R1+R2 punt（流程审计 / 不阻塞功能 / cost）/ M16+M17 happy path full + M18 hybrid + WS golden 推下次专 sprint（mock provider + multipart + WS 客户端各自独立基础设施）
