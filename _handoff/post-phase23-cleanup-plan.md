...
status_sprint2: 🟡 PARTIAL 2026-05-10 / Task 2.1+2.2 基础设施 ✅ + Task 2.3 spec 03/04/05/06 ✅（10 e2e PASS / 含 D 类 #3 join 实证 + L1-α detach 实证 + 修 4C.3 expunge fix）/ Task 2.3 spec 07-10（AI snapshot / import-export / search / relation graph）punt（依赖 mock provider / WS / multipart / XYFlow 交互 / 各自独立子 sprint）/ Task 2.4 pytest-benchmark 1000 seed punt（$1-2 / 独立后端工作）/ Task 2.5 R1+R2 punt（cost）
